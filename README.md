...
you can test your tasks against the unreliable server [url](https://web.dev.accurx.com/api/desktop/download/unreliable?delay=<milliseconds>) which simulates the various unreliable testing conditions